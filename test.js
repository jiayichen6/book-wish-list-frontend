const works = [
  ...
  },
  {
    ...
    subject: [
      ...
      "Karénine, Anna (Personnage fictif)",
      "Conditions sociales",
      "Mœurs et coutumes",
    ],
    ia_collection: [
    ...
    printdisabled: true,
    lending_edition: "OL39201928M",
    lending_identifier: "annakareninaroma00tols",
    authors: [
      {
    ...
    availability: {
      ...
      is_lendable: false,
      is_previewable: true,
      identifier: "annakareninaroma00tols",
      isbn: null,
      oclc: null,
      openlibrary_work: "OL28591629W",
      openlibrary_edition: "OL39201928M",
      last_loan_date: null,
      num_waitlist: null,
      last_waitlist_date: null,
      is_restricted: false,
  ...
  },
  {
    ...
    printdisabled: true,
    lending_edition: "OL45855086M",
    lending_identifier: "dergrafvonmontec0000alex_x8p1",
    authors: [
      {
    ...
    ia: "dergrafvonmontec0000alex_x8p1",
    public_scan: true,
    has_fulltext: true,
    availability: {
      status: "open",
      ...
      is_lendable: false,
      is_previewable: true,
      identifier: "dergrafvonmontec0000alex_x8p1",
      isbn: null,
      oclc: null,
      openlibrary_work: "OL36287W",
      openlibrary_edition: "OL45855086M",
      last_loan_date: null,
      num_waitlist: null,
      last_waitlist_date: null,
      is_restricted: false,
  ...
  },
  {
    ...
    ia: "lp_the-sonnets-of-william-shakespeare_the-sonnets-of-william-shakespeare",
    public_scan: true,
    has_fulltext: true,
    availability: {
      status: "open",
  ...
  },
  {
    ...
    printdisabled: true,
    lending_edition: "OL46944916M",
    lending_identifier: "chroniclesofavon0000lucy_x3t0",
    authors: [
      {
        key: "/authors/OL39485A",
        name: "Lucy Maud Montgomery",
      },
    ],
    first_publish_year: 1912,
    ia: "chroniclesofavon0000lucy_x3t0",
    public_scan: true,
    has_fulltext: true,
    availability: {
      status: "open",
      ...
      is_lendable: false,
      is_previewable: true,
      identifier: "chroniclesofavon0000lucy_x3t0",
      isbn: "9781511627740",
      oclc: null,
      openlibrary_work: "OL77788W",
      openlibrary_edition: "OL46944916M",
      last_loan_date: null,
      num_waitlist: null,
      last_waitlist_date: null,
      is_restricted: false,
  ...
  },
  {
    ...
    printdisabled: true,
    lending_edition: "OL24831899M",
    lending_identifier: "lavitanuova00dant",
    authors: [
      {
      ...
      {
        key: "/authors/OL5274288A",
        name: "Dante Gabriel Rossetti",
      },
      {
        key: "/authors/OL289681A",
        name: "Michael Palmer",
      },
      {
        key: "/authors/OL2700032A",
        name: "Dante Rossetti",
      },
      {
        key: "/authors/OL9656601A",
        name: "Roger Grass",
      },
    ],
    first_publish_year: 1829,
    ia: "lavitanuova00dant",
    public_scan: true,
    has_fulltext: true,
    availability: {
      status: "open",
      ...
      is_lendable: false,
      is_previewable: true,
      identifier: "lavitanuova00dant",
      isbn: null,
      oclc: null,
      openlibrary_work: "OL93228W",
      openlibrary_edition: "OL24831899M",
      last_loan_date: null,
      num_waitlist: null,
      last_waitlist_date: null,
      is_restricted: false,
  ...
  },
  {
    ...
    lending_identifier:
      "synapseml_gutenberg_the_sea_gull_by_anton_pavlovich_chekhov",
    authors: [
      {
  ...
  },
  {
    ...
    printdisabled: true,
    lending_edition: "OL42927421M",
    lending_identifier: "rebeccainfrenchd0000daph",
    authors: [
      {
    ...
    availability: {
      ...
      is_lendable: true,
      is_previewable: true,
      identifier: "rebeccainfrenchd0000daph",
      isbn: null,
      oclc: null,
      openlibrary_work: "OL36633W",
      openlibrary_edition: "OL42927421M",
      last_loan_date: null,
      num_waitlist: null,
      last_waitlist_date: null,
      is_restricted: true,
  ...
  },
  {
    ...
    printdisabled: true,
    lending_edition: "OL36620498M",
    lending_identifier: "riwageyisheng0000past",
    authors: [
      {
    ...
    availability: {
      ...
      is_lendable: true,
      is_previewable: true,
      identifier: "riwageyisheng0000past",
      isbn: "9787550602526",
      oclc: null,
      openlibrary_work: "OL258301W",
      openlibrary_edition: "OL36620498M",
      last_loan_date: null,
      num_waitlist: null,
      last_waitlist_date: null,
      is_restricted: true,
  ...
  },
  {
    ...
    edition_count: 166,
    cover_id: 8247735,
    cover_edition_key: "OL7090288M",
    subject: [
      "Fiction",
      "Social life and customs",
      "England in fiction",
      "English national characteristics in fiction",
    ...
    printdisabled: true,
    lending_edition: "OL25914969M",
    lending_identifier: "bracebridgehallo00irvi_0",
    authors: [
      {
    ...
    availability: {
      ...
      is_lendable: false,
      is_previewable: true,
      identifier: "bracebridgehallo00irvi_0",
      isbn: null,
      oclc: null,
      openlibrary_work: "OL17338276W",
      openlibrary_edition: "OL25914969M",
      last_loan_date: null,
      num_waitlist: null,
      last_waitlist_date: null,
      is_restricted: false,
  ...
  },
  {
    ...
    printdisabled: true,
    lending_edition: "OL40208661M",
    lending_identifier: "guesshowmuchilov0000mcbr_w9f7",
    authors: [
      {
    ...
    ia: "guesshowmuchilov0000mcbr_w9f7",
    public_scan: false,
    has_fulltext: true,
    availability: {
      status: "borrow_available",
      ...
      is_lendable: true,
      is_previewable: true,
      identifier: "guesshowmuchilov0000mcbr_w9f7",
      isbn: "9781406349559",
      oclc: null,
      openlibrary_work: "OL20407585W",
      openlibrary_edition: "OL40208661M",
      last_loan_date: null,
      num_waitlist: null,
      last_waitlist_date: null,
      is_restricted: true,
  ...
  },
  {
    ...
    availability: {
      ...
      is_lendable: false,
      is_previewable: true,
      identifier: "bwb_Y0-BED-586",
      isbn: null,
      oclc: null,
      openlibrary_work: "OL41495W",
      openlibrary_edition: "OL37797986M",
      last_loan_date: null,
      num_waitlist: null,
      last_waitlist_date: null,
      is_restricted: true,
  ...
  {
    key: "/works/OL2100998W",
    title: "Vies des dames galantes",
    edition_count: 96,
    cover_id: 5750631,
    cover_edition_key: "OL6539539M",
    subject: [
      "Biography",
      "Women",
      "Court and courtiers",
    ...
    printdisabled: false,
    lending_edition: "OL26528878M",
    lending_identifier: "bookofladies0000bran",
    authors: [
      {
        key: "/authors/OL259689A",
        name: "Pierre de Bourdeille, seigneur de Brantôme",
      },
    ],
    first_publish_year: 1722,
    ia: "bookofladies0000bran",
    public_scan: true,
    has_fulltext: true,
    availability: {
      status: "open",
      ...
      is_lendable: false,
      is_previewable: true,
      identifier: "bookofladies0000bran",
      isbn: null,
      oclc: null,
      openlibrary_work: "OL17939111W",
      openlibrary_edition: "OL26528878M",
      last_loan_date: null,
      num_waitlist: null,
      last_waitlist_date: null,
      is_restricted: false,
  ...
  },
  {
    ...
    printdisabled: true,
    lending_edition: "OL33215041M",
    lending_identifier: "steppingheavenwa00pren_0",
    authors: [
      {
        key: "/authors/OL68343A",
        name: "Elizabeth Prentiss",
      },
    ],
    first_publish_year: 1869,
    ia: "steppingheavenwa00pren_0",
    public_scan: true,
    has_fulltext: true,
    availability: {
      status: "open",
      ...
      is_lendable: false,
      is_previewable: true,
      identifier: "steppingheavenwa00pren_0",
      isbn: null,
      oclc: null,
      openlibrary_work: "OL811123W",
      openlibrary_edition: "OL33215041M",
      last_loan_date: null,
      num_waitlist: null,
      last_waitlist_date: null,
      is_restricted: false,
  ...
  },
  {
    ...
    printdisabled: true,
    lending_edition: "OL49203562M",
    lending_identifier: "eastofedenbyjohn0000john",
    authors: [
      {
    ...
    availability: {
      ...
      is_lendable: true,
      is_previewable: true,
      identifier: "eastofedenbyjohn0000john",
      isbn: null,
      oclc: null,
      openlibrary_work: "OL23166W",
      openlibrary_edition: "OL49203562M",
      last_loan_date: null,
      num_waitlist: null,
      last_waitlist_date: null,
      is_restricted: true,
  ...
  },
  {
    ...
    printdisabled: true,
    lending_edition: "OL32121072M",
    lending_identifier: "linsostenibilele0000kund",
    authors: [
      {
      ...
      {
        key: "/authors/OL10221409A",
        name: "Milan Kundera",
      },
    ],
    first_publish_year: 1984,
    ia: "linsostenibilele0000kund",
    public_scan: false,
    has_fulltext: true,
    availability: {
      status: "borrow_available",
      ...
      is_lendable: true,
      is_previewable: true,
      identifier: "linsostenibilele0000kund",
      isbn: "8481304999",
      oclc: null,
      openlibrary_work: "OL24282532W",
      openlibrary_edition: "OL32121072M",
      last_loan_date: null,
      num_waitlist: null,
      last_waitlist_date: null,
      is_restricted: true,
  ...
  },
  {
    ...
    printdisabled: true,
    lending_edition: "OL33065903M",
    lending_identifier: "b20421746",
    authors: [
      {
    ...
    availability: {
      ...
      is_lendable: false,
      is_previewable: true,
      identifier: "b20421746",
      isbn: null,
      oclc: null,
      openlibrary_work: "OL15822096W",
      openlibrary_edition: "OL33065903M",
      last_loan_date: null,
      num_waitlist: null,
      last_waitlist_date: null,
      is_restricted: false,
  ...
  {
    key: "/works/OL10342794W",
    title: "Bodas de sangre",
    edition_count: 61,
    cover_id: 5268273,
    cover_edition_key: "OL22098197M",
    subject: [
      "Arranged marriage",
      "Drama",
      "Weddings",
      ...
      "Teatro español",
      "Spanish drama",
      "Teatro del pueblo (Buenos Aires, Argentina)",
    ],
    ia_collection: [
      "americana",
      "dartmouthlibrary-ol",
    ...
    printdisabled: true,
    lending_edition: "OL24385440M",
    lending_identifier: "bodasdesangre00garc",
    authors: [
      {
    ...
    availability: {
      ...
      is_lendable: true,
      is_previewable: true,
      identifier: "bodasdesangre00garc",
      isbn: null,
      oclc: null,
      openlibrary_work: "OL15416257W",
      openlibrary_edition: "OL24385440M",
      last_loan_date: null,
      num_waitlist: null,
      last_waitlist_date: null,
      is_restricted: true,
...
const descs = [
  ...
  },
  {
    book: "Anna Karenina",
    description:
      "Anna Karenina is a novel, first published in book form in 1878, by the Russian author Leo Tolstoy. Tolstoy called it his first true novel. It was initially released in serial installments from 1875 to 1877, all but the last part appearing in the periodical The Russian Messenger. By the time he was finishing up the last installments, Tolstoy was in an anguished state of mind and, having come to hate it but finished it unwillingly.",
  },
  {
    book: "πολιτεία",
    description:
      '\nPoliteia is an ancient Greek word used in Greek political thought, especially that of Plato and Aristotle. Derived from the word polis ("city-state"), it has a range of meanings from "the rights of citizens" to a "form of government" to "commonwealth."',
  },
  {
  ...
  {
    book: "Works [37 plays, 6 poems, sonnets]",
    description: "No description found.",
  },
  {
    book: "Чайка",
  ...
  {
    book: "الروض العاطر في نزهة الخاطر",
    description: "No description found.",
  },
  {
  ...
  },
  {
    book: "Amores",
    description:
      "Amores may refer to:Amores (Ovid), the first book by the poet Ovid, published in 5 volumes in 16 BCE\nAmores (Lucian), a play by Lucian; also known as Erotes\nErotes (mythology), known as Amores by the Romans\nAmores, a book of poetry by D. H. Lawrence\nAmores, a piece for percussion group and prepared piano composed by John Cage\nAmores, a BRT station in Mexico City\n\n",
  },
  {
    book: "Psychopathia sexualis",
    description:
      'Psychopathia Sexualis: eine klinisch-forensische Studie is an 1886 book by Richard Freiherr von Krafft-Ebing and one of the first texts about sexual pathology. The book details a wide range of paraphilias and focuses on male homosexuality/bisexuality. The book coined the terms "sadism and masochism" as well as borrowing the term "bisexual" from botanical nomenclature.',
  },
  {
    book: "Introduction à la vie dévote",
    description: "No description found.",
  },
  {
    book: "De l'amour",
...
const descWithKey = descs.map((desc) => {
  const match = works.find((book) => book.title === desc.book);
  return {
    key: match?.key || null, // 找不到就設為 null（你也可以 throw error）
    ...desc,
  };
});

console.log(JSON.stringify(descWithKey));
